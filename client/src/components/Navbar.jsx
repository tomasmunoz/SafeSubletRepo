    ...
    <div class="row">
      <div class="col-12">
        <nav class="navbar navbar-expand-lg  blur border-radius-xl mt-4 top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container">
            <Link class="navbar-brand text-white" to="#" target="_blank">
              SafeSublet
            </Link>
            ...
            <ul class="navbar-nav navbar-nav-hover ms-auto">
              <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
                <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" id="dropdownMenuPages8" data-bs-toggle="dropdown" aria-expanded="false">
                  ...
                  Pages
                  <img src="../assets/img/down-arrow-white.svg" class="arrow ms-2 d-lg-block d-none"/>
                  <img src="../assets/img/down-arrow-dark.svg" class="arrow ms-2 d-lg-none d-block"/>
                </a>
                <div class="dropdown-menu dropdown-menu-animation ms-n3 dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages8">
                  <div class="d-none d-lg-block">
                    ...
                    <Link to="/about-us" class="dropdown-item border-radius-md">
                      <span>About Us</span>
                    </Link>
                    <Link to="/contact-us" class="dropdown-item border-radius-md">
                      <span>Contact Us</span>
                    </Link>
                    <Link to="/marketing" class="dropdown-item border-radius-md">
                      <span>Marketing</span>
                    </Link>
                    <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-1 mt-3">
                      Account
                    </h6>
                    <Link class="dropdown-item border-radius-md">
                      <span>Sign In</span>
                    </Link>
                  </div>
                  <div class="d-lg-none">
                    ...
                    <Link to="/sign-in" class="dropdown-item border-radius-md">
                      <span>Sign In</span>
                    </Link>
                  </div>
                </div>
